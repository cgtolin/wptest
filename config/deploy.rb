...
set :wp_user, "cgtolin" # The admin username
set :wp_email, "cgtolin@gmail.com" # The admin email address
...
set :application, "wp-test"
set :repo_url, "git@github.com:cgtolin/wptest.git"
set :scm, :git
